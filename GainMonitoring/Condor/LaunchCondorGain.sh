...
executable   = /afs/cern.ch/user/v/valcayne/Workspace/2026_Sm/GainMonitoring/DoGainCorrecting
arguments    = $(run)
...
queue run from /afs/cern.ch/user/v/valcayne/Workspace/2026_Sm/GainMonitoring/Condor/ArgumentsForCondor.txt
