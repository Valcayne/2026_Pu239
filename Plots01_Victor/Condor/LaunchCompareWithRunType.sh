...
executable   = /afs/cern.ch/user/v/valcayne/Workspace/2026_Sm/Plots01_Victor/CompareWithRunType
arguments    = $(run)
...
queue   run from /afs/cern.ch/user/v/valcayne/Workspace/2026_Sm/Plots01_Victor/Condor/ArgumentsForCondor.txt
