...
int main(int argc, char** argv) {
  ...
  string DataFolder =
      ...
      "HistoAmp_v07";
  string RunList =
      "/afs/cern.ch/user/v/valcayne/Workspace/2026_Sm/"
      "RunLists/RunList2024_02.txt";
  string FolderRootFiles = "/eos/experiment/ntof/data/rootfiles/2024/ear1/";
  ...
  string outFolder =
      "/eos/home-v/valcayne/nTOFDataProcessing/2024_Er_Cu_U/Calibration/"
      "OutputMakeEnergyCalibration_v07";
