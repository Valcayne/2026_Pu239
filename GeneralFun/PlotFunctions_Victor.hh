...
void DivideByNeutronFluence_EAR2(TH1D* h1) {
  ...
  cout << " Dividing by neutron fluence "
          "...DataPlot/Final_evaluated_flux_Phase4_EAR2.root"
       << endl;
  TFile* f1 =
      new TFile("DataPlot/Final_evaluated_flux_Phase4_EAR2.root", "READ");
  ...
  // s TH1F* n_flux = (TH1F*)f1->Get("hEnergy");
  TH1F* n_flux = (TH1F*)f1->Get("h_flux_ear2");
