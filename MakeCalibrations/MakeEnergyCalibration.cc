...
void FitEnergy(string outfolder, int detn) {
  ...
  string OutName_pol1 = outfolder + "/DataCalibration_pol1.out";
  string OutName_pol2 = outfolder + "/DataCalibration_pol2.out";
  ...
  TF1* myfitpol2 =
      new TF1("myfitpol2", "[0] + [1]*x + [2]*x*x", 0.1, 100000);  // pol2
  ...
  TF1* myfitpol3 =
      new TF1("myfitpol3", FunPol2andPol1, 0.1, 100000, 4);  // pol3
  ...
  // First we adjusted only the low energy . In particular we adjusted below 1.1
  // MeV
  gr->Fit("myfitpol3", "R0");
  ...
  cout << "p0pol12 " << p0pol12 << " p1pol12 " << p1pol12 << " p2pol12 "
       << p2pol12 << " p3pol12 " << p3pol12 << endl;
  ...
  out << "SecondDegree" << endl
      << p0pol2 << "  " << p1pol2 << " " << p2pol2 << endl;
  out << " 0 0 0 0  " << p0pol2 << "  " << p1pol2 << " " << p2pol2 << endl
      << endl;

  out << "Pol12" << endl
      << p0pol12 << "  " << p1pol12 << " " << p2pol12 << " " << p3pol12 << endl;
  out << p0pol12 << "  " << p1pol12 << " " << p2pol12 << " " << p3pol12 << " "
      << -p2pol12 * p3pol12 * p3pol12 + p0pol12 << " "
      << 2 * p2pol12 * p3pol12 + p1pol12 << "  0  " << endl
      << endl;
  ...
  ofstream outAllDet_pol1(OutName_pol1, ios::out | ios::app | ios::binary);
  ofstream outAllDet_pol2(OutName_pol2, ios::out | ios::app | ios::binary);
  ...
  outAllDet << detn << " " << p0pol12 << "  " << p1pol12 << " " << p2pol12
            ...
            << " " << 2 * p2pol12 * p3pol12 + p1pol12 << "  0  " << endl;
  outAllDet_pol1 << detn << " 0 0 0 0   " << p0pol1 << "  " << p1pol1 << " 0  "
                 << endl;

  outAllDet_pol2 << detn << " 0 0 0 0  " << p0pol2 << "  " << p1pol2 << " "
                 << p2pol2 << endl;

  outAllDet.close();
  outAllDet_pol1.close();
  outAllDet_pol2.close();
  out.close();
}
////////////////
