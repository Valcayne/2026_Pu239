...
int main(int argc, char** argv) {
  ...
  // std::vector<int> DetectorsCalibrated = {2};

  // Information MC
  // string MCFolder =
  //     "/eos/home-v/valcayne/nTOFDataProcessing/2024_27sTED/Simulations/9sTED_";
  string MCFolder =
      "/eos/home-v/valcayne/nTOFDataProcessing//2024_27sTED/Simulations/v03/"
      "2024_27sTED_";

  // string MCFolder =
  //     "/eos/home-v/valcayne/nTOFDataProcessing/2024_27sTED/Simulations/v01/"
  //     "_";
  ...
  string DataFolder =
      "/eos/home-v/valcayne/nTOFDataProcessing/2024_27sTED/Calibration/"
      "HistoAmp_2026_v02";
  string RunList =
      "/afs/cern.ch/work/v/valcayne/2024_27sTED/RunLists/"
      "RunList_2026_v01.txt";
  // string FolderRootFiles =
  //     "/eos/user/v/valcayne/nTOFDataProcessing/2024_27sTED/RootFiles/v01/done";
  ...
  string outFolder =
      "/eos/home-v/valcayne/nTOFDataProcessing/2024_27sTED/Calibration/"
      "OutputMakeEnergyCalibration_2026_v02";
  ...
  for (int j = 0; j < (int)DetectorsCalibrated.size(); j++) {
    ...
    if (LaunchFitPoints) {
      ...
      if (!FileExists(NameoutputFile)) {
        ...
        // outdata << DetectorsCalibrated[j] << " " << outFolder << "  " <<
        // endl;
